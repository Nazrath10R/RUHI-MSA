...
# df <- df[which(df$PeptideProphet.Probability > 0.6),]
...
write.table(output_table, "~/Desktop/ptm/ptm/ptm/input/fragger_pp.txt", quote = FALSE, row.names = FALSE,  col.names = FALSE)
